...
public class ClientController {
    ...
    public ModelAndView edit(@PathVariable Integer clientId) {
        ...
        if( client == null ) {
	        ...
	        mav.addObject("client", client);
	        mav.addObject("unassociated", personService.listUnAssociated( clientId ) );
	        mav.addObject("errors", new ArrayList<String>());
	        return mav;
        }
    }
    ...
    public ModelAndView edit(Client client) {
        ...
        if (errors.isEmpty()) {
            ...
            ModelAndView mav = new ModelAndView("client/edit");
            mav.addObject("client", client);
            mav.addObject("unassociated", personService.listUnAssociated( client.getClientId() ) );
            mav.addObject("errors", errors);
            return mav;
        }
    }
    ...
    public String delete(@RequestParam String command, @RequestParam Integer clientId) {
    	/** TODO:
    	 * Update associated contacts to delete person.client_id
    	 */
